...
import com.bixw.recyclerview.YncPullRefreshHeader;
import com.ync365.ptrrecyclerview.BaseRecyclerAdapter;
import com.ync365.ptrrecyclerview.BaseRecyclerViewHolder;
import com.ync365.ptrrecyclerview.IViewType;
import com.ync365.ptrrecyclerview.PtrRecyclerView;

import java.util.ArrayList;

public class TestActivity extends AppCompatActivity implements BaseRecyclerAdapter.OnRecyclerViewItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        YncPullRefreshHeader header = new YncPullRefreshHeader(this);
        mRecyclerView.setPullRefreshHeaderView(header);
        mRecyclerView.setMode(PtrRecyclerView.RecyclerMode.BOTH);
    ...
    public void onItemClick(View itemView, Object itemBean, int position) {
        Toast.makeText(TestActivity.this, "data:" + itemBean + "    position:" + position, Toast.LENGTH_SHORT).show();
    }
}
